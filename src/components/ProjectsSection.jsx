...
gsap.fromTo(
 ...
 <div className='container mx-auto px-4 mb-16 relative z-10'>
      ...
      <div ref={ titleLineRef } className='w-0 h-0 bg-gradient-to-r from-purple-500 to-pink-500 mx-auto opacity-0 '></div>
  
   </div>
 
 {/* horizantal scrolling projects */}
    ...
    <div ref={horizontalRef} className='horizontal-section flex md:w-[400%] w-[420%] '>
      ...
      {projectImages.map((project) => (
       ...
       className='panel relative flex items-center justify-center'>
        <div className='releative w-full h-full flex flex-col items-center justify-center p-4 sm:p-8  md:p-12 '>
